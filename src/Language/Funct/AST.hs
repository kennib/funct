...
data Definition = AliasDefinition Alias Hash | TypeDefinition Type | FunctionDefinition Function
    deriving (Show)
...
data Type = SumType [Type] | ProductType [Type] | TypeHash Hash | TypeAlias Alias
    deriving (Show)
